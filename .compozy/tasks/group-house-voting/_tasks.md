...
| 04 | URL parsing and async OG scraper in `app/scraper.py` | pending | medium | task_01 |
| 05 | FastHTML app factory, base layout, shared FT components | pending | medium | task_01, task_02, task_03 |
